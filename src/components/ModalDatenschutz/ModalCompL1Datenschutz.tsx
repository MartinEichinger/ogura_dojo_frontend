...
import { IContentDatenschutz } from './ModalDatenschutz';

const ModalCompL1Datenschutz = ({ content }: { content: IContentDatenschutz }) => {
  const debug = false;

  if (debug) console.log('ModalComp_L1_Datenschutz: ', content);
      ...
      <div className="impressum scroll_">
        <div
          dangerouslySetInnerHTML={{
            __html: content?.datenschutz?.translations?.[0]?.datenschutz,
          }}
        />
      </div>
    </ModalCol>
...
export default ModalCompL1Datenschutz;
